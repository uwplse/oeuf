...
Definition v___stringlit_4 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 66) :: Init_int8 (Int.repr 101) ::
                ...
                Init_int8 (Int.repr 101) :: Init_int8 (Int.repr 44) ::
                Init_int8 (Int.repr 32) :: Init_int8 (Int.repr 116) ::
...
Definition f_get_time := {|
  ...
  fn_params := nil;
  fn_vars := (192%positive :: 191%positive :: nil);
  fn_stackspace := 52;
  fn_body :=
(Sseq
  (Sseq
    ...
    (Sstore Mint32 (Econst (Oaddrstack (Int.repr 0))) (Evar 191%positive)))
  (Sseq
    (Sseq
      ...
      (Sbuiltin None (EF_memcpy 44 4)
        ((Econst (Oaddrstack (Int.repr 8))) :: (Evar 192%positive) :: nil)))
    (Sseq
      (Scall None
        (mksignature
...
Definition f_make_nat := {|
  ...
  fn_params := (_n :: nil);
  fn_vars := (_ptr :: _i :: _tmp :: 194%positive :: 193%positive :: nil);
  fn_stackspace := 0;
  fn_body :=
(Sseq
  (Sseq
    (Scall (Some 193%positive)
      ...
      (Econst (Oaddrsymbol _malloc (Int.repr 0)))
      ((Econst (Ointconst (Int.repr 4))) :: nil))
    (Sassign _ptr (Evar 193%positive)))
  (Sseq
                  ...
                  (Sseq
                    (Sseq
                      (Scall (Some 194%positive)
                        ...
                        (Econst (Oaddrsymbol _malloc (Int.repr 0)))
                        ((Econst (Ointconst (Int.repr 8))) :: nil))
                      (Sassign _tmp (Evar 194%positive)))
                    (Sseq
...
Definition f_make_unit := {|
  fn_sig := (mksignature nil (Some AST.Tint) cc_default);
  fn_params := nil;
  fn_vars := (_result :: 195%positive :: nil);
  fn_stackspace := 0;
  fn_body :=
(Sseq
  (Sseq
    (Scall (Some 195%positive)
      ...
      (Econst (Oaddrsymbol _malloc (Int.repr 0)))
      ((Econst (Ointconst (Int.repr 4))) :: nil))
    (Sassign _result (Evar 195%positive)))
  (Sseq
...
Definition f_make_bool := {|
  fn_sig := (mksignature (AST.Tint :: nil) (Some AST.Tint) cc_default);
  fn_params := (_b :: nil);
  fn_vars := (_result :: 197%positive :: 196%positive :: nil);
  fn_stackspace := 0;
  fn_body :=
(Sseq
  (Sseq
  ...
  (Sseq
    (Sseq
      ...
      (Sstore Mint32 (Evar _result) (Evar 197%positive)))
    (Sreturn (Some (Evar _result)))))
|}.
...
(Sseq
  (Scall (Some 199%positive)
    ...
    ((Evar _f) :: (Evar _a) :: nil))
  (Sreturn (Some (Evar 199%positive))))
|}.
...
Definition f_vcall := {|
  fn_sig := (mksignature (AST.Tint :: nil) (Some AST.Tint)
              {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|});
  fn_params := (_f :: nil);
  fn_vars := (_a :: 202%positive :: 201%positive :: 200%positive :: nil);
  fn_stackspace := 4;
  fn_body :=
(Sseq
...
Definition f_main := {|
  ...
  fn_vars := (_n :: _end :: _nil_value :: _cons_closure :: _zero_value ::
              _succ_closure :: _max_list_closure :: _l :: _n_copy ::
              _oeuf_n :: _max :: 211%positive :: 210%positive ::
              209%positive :: 208%positive :: 207%positive :: 206%positive ::
              205%positive :: 204%positive :: 203%positive :: nil);
  fn_stackspace := 0;
  fn_body :=
(Sseq
  (Sseq
    ...
    (Sseq
      (Sseq
        (Scall (Some 203%positive)
          ...
          ((Econst (Ointconst (Int.repr 0))) ::
           (Econst (Ointconst (Int.repr 0))) :: nil))
        (Sassign _nil_value (Evar 203%positive)))
      (Sseq
        (Sseq
          (Scall (Some 204%positive)
            ...
            ((Econst (Ointconst (Int.repr 0))) ::
             (Econst (Ointconst (Int.repr 0))) :: nil))
          (Sassign _cons_closure (Evar 204%positive)))
        (Sseq
          (Sseq
            (Scall (Some 205%positive)
              ...
              ((Econst (Ointconst (Int.repr 0))) ::
               (Econst (Ointconst (Int.repr 0))) :: nil))
            (Sassign _zero_value (Evar 205%positive)))
          (Sseq
            (Sseq
              (Scall (Some 206%positive)
                ...
                ((Econst (Ointconst (Int.repr 0))) ::
                 (Econst (Ointconst (Int.repr 0))) :: nil))
              (Sassign _succ_closure (Evar 206%positive)))
            (Sseq
              (Sseq
                (Scall (Some 207%positive)
                  ...
                  ((Econst (Ointconst (Int.repr 0))) ::
                   (Econst (Ointconst (Int.repr 0))) :: nil))
                (Sassign _max_list_closure (Evar 207%positive)))
              (Sseq
                                          ...
                                          (Sseq
                                            ...
                                            (Scall None
                                              (mksignature
                                                ...
                                                {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})
                                              (Econst (Oaddrsymbol _printf (Int.repr 0)))
                                              ((Econst (Oaddrsymbol ___stringlit_6 (Int.repr 0))) ::
                                               (Evar _n_copy) :: nil)))))))))))))))
                  (Sseq
                    (Scall None
                      (mksignature (AST.Tint :: nil) (Some AST.Tint)
                        {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})
                      (Econst (Oaddrsymbol _printf (Int.repr 0)))
                      ((Econst (Oaddrsymbol ___stringlit_7 (Int.repr 0))) ::
                       nil))
                    (Sseq
                      (Sseq
                        (Scall (Some 210%positive)
                          ...
                          ((Evar _max_list_closure) :: (Evar _l) ::
                           (Econst (Ointconst (Int.repr 0))) :: nil))
                        (Sassign _max (Evar 210%positive)))
                      (Sseq
                        (Sseq
...
(_main :: _cons :: _nil :: _succ :: _zero :: _max_list :: _vcall :: _call ::
 ...
 _make_nat :: _get_time :: _localtime :: _time :: _malloc :: _snprintf ::
