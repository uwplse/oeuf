...
Definition f_get_time := {|
  ...
  fn_params := nil;
  fn_vars := (134%positive :: 133%positive :: nil);
  fn_stackspace := 52;
  fn_body :=
(Sseq
  (Sseq
    ...
    (Sstore Mint32 (Econst (Oaddrstack (Int.repr 0))) (Evar 133%positive)))
  (Sseq
    (Sseq
      ...
      (Sbuiltin None (EF_memcpy 44 4)
        ((Econst (Oaddrstack (Int.repr 8))) :: (Evar 134%positive) :: nil)))
    (Sseq
      (Scall None
        (mksignature
...
Definition f_make_nat := {|
  ...
  fn_params := (_n :: nil);
  fn_vars := (_ptr :: _i :: _tmp :: 136%positive :: 135%positive :: nil);
  fn_stackspace := 0;
  fn_body :=
(Sseq
  (Sseq
    (Scall (Some 135%positive)
      ...
      (Econst (Oaddrsymbol _malloc (Int.repr 0)))
      ((Econst (Ointconst (Int.repr 4))) :: nil))
    (Sassign _ptr (Evar 135%positive)))
  (Sseq
                  ...
                  (Sseq
                    (Sseq
                      (Scall (Some 136%positive)
                        ...
                        (Econst (Oaddrsymbol _malloc (Int.repr 0)))
                        ((Econst (Ointconst (Int.repr 8))) :: nil))
                      (Sassign _tmp (Evar 136%positive)))
                    (Sseq
...
Definition f_make_unit := {|
  fn_sig := (mksignature nil (Some AST.Tint) cc_default);
  fn_params := nil;
  fn_vars := (_result :: 137%positive :: nil);
  fn_stackspace := 0;
  fn_body :=
(Sseq
  (Sseq
    (Scall (Some 137%positive)
      ...
      (Econst (Oaddrsymbol _malloc (Int.repr 0)))
      ((Econst (Ointconst (Int.repr 4))) :: nil))
    (Sassign _result (Evar 137%positive)))
  (Sseq
...
Definition f_make_bool := {|
  fn_sig := (mksignature (AST.Tint :: nil) (Some AST.Tint) cc_default);
  fn_params := (_b :: nil);
  fn_vars := (_result :: 139%positive :: 138%positive :: nil);
  fn_stackspace := 0;
  fn_body :=
(Sseq
  (Sseq
    (Scall (Some 138%positive)
      ...
      (Econst (Oaddrsymbol _malloc (Int.repr 0)))
      ((Econst (Ointconst (Int.repr 4))) :: nil))
    (Sassign _result (Evar 138%positive)))
  (Sseq
    (Sseq
      (Sifthenelse (Ebinop (Ocmp Cne) (Evar _b)
                     (Econst (Ointconst (Int.repr 0))))
        (Sassign 139%positive (Econst (Ointconst (Int.repr 0))))
        (Sassign 139%positive (Econst (Ointconst (Int.repr 1)))))
      (Sstore Mint32 (Evar _result) (Evar 139%positive)))
    (Sreturn (Some (Evar _result)))))
|}.
...
(Sseq
  (Scall (Some 141%positive)
    ...
    ((Evar _f) :: (Evar _a) :: nil))
  (Sreturn (Some (Evar 141%positive))))
|}.
...
Definition f_vcall := {|
  fn_sig := (mksignature (AST.Tint :: nil) (Some AST.Tint)
              {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|});
  fn_params := (_f :: nil);
  fn_vars := (_a :: 144%positive :: 143%positive :: 142%positive :: nil);
  fn_stackspace := 4;
  fn_body :=
(Sseq
                ...
                (Sseq
                  (Sseq
                    (Scall (Some 142%positive)
                      ...
                      ((Econst (Oaddrstack (Int.repr 0))) :: nil))
                    (Sassign 143%positive (Evar 142%positive)))
                  (Sassign _a (Evar 143%positive)))
                (Sifthenelse (Ebinop (Ocmpu Cne) (Evar 143%positive)
                               (Econst (Ointconst (Int.repr 0))))
                  Sskip
                  (Sexit (S O))))
              (Sseq
...
Definition f_main := {|
  fn_sig := (mksignature nil (Some AST.Tint) cc_default);
  fn_params := nil;
  fn_vars := (_n :: _long_id_closure :: _m :: 149%positive :: 148%positive ::
              147%positive :: 146%positive :: 145%positive :: nil);
  fn_stackspace := 0;
  fn_body :=
(Sseq
  (Sseq
    (Sseq
      ...
      (Sassign _n (Evar 145%positive)))
    (Sseq
      (Sseq
        (Scall (Some 146%positive)
          (mksignature (AST.Tint :: AST.Tint :: nil) (Some AST.Tint)
            cc_default) (Econst (Oaddrsymbol _long_id (Int.repr 0)))
          ((Econst (Ointconst (Int.repr 0))) ::
           (Econst (Ointconst (Int.repr 0))) :: nil))
        (Sassign _long_id_closure (Evar 146%positive)))
      (Sseq
        (Sseq
          (Scall (Some 147%positive)
            ...
            ((Evar _long_id_closure) :: (Evar _n) ::
             (Econst (Ointconst (Int.repr 0))) :: nil))
          (Sassign _m (Evar 147%positive)))
        (Sseq
          (Sseq
            (Sseq
            ...
            (Scall None
              ...
              ((Econst (Oaddrsymbol ___stringlit_3 (Int.repr 0))) ::
               (Evar 148%positive) :: (Evar 149%positive) :: nil)))
...
prog_public :=
(_main :: _long_id :: _vcall :: _call :: _print_list_nat :: _read_bool ::
